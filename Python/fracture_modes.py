...
class fracture_modes:
    ...
    def impact_projection(self,contact_point=None,threshold=0.02,wave=True,direction=np.array([1]),
                            impact=None,project_on_modes=False,num_modes_used = None):
    ...
    '''
    my method 01: return ui and gi for new mesh
    '''
    ...
    '''
    my method 03: only ui,gi return to check how to fracture
    '''
